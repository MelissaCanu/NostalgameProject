        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoAbbonamento = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CostoMensile = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdRegistrazione = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Registrazioni", x => x.IdRegistrazione);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostoSpedizione = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PagamentiAbbonamenti",
                columns: table => new
                {
                    IdPagamentoAbbonamento = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdUtente = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IdAbbonamento = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PagamentiAbbonamenti", x => x.IdPagamentoAbbonamento);
                    table.ForeignKey(
                        name: "FK_PagamentiAbbonamenti_AspNetUsers_IdUtente",
                        column: x => x.IdUtente,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Piattaforma = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CasaProduttrice = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    IdGenere = table.Column<int>(type: "int", nullable: false),
                    IdProprietario = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Videogiochi", x => x.IdVideogioco);
                    table.ForeignKey(
                        name: "FK_Videogiochi_AspNetUsers_IdProprietario",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PagamentiAbbonamenti_IdUtente",
                table: "PagamentiAbbonamenti",
                column: "IdUtente");

            migrationBuilder.CreateIndex(
                name: "IX_Videogiochi_IdProprietario",
                table: "Videogiochi",
